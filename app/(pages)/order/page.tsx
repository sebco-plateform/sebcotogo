...
import {OrderArticleModel} from "@/models/OrderArticle";
                ...
                await fetch(`/api/send`, {
                    ...
                    if (val.ok) {
                        toast({
                            ...
                            description: "Une  emaill de confirmation vous a été destiner!"
                        });

                        route.push(`/congratulation/${datas.id}`)
